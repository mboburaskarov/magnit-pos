...
var HTMLMaskElement = class _HTMLMaskElement extends MaskElement {
...
var MaskedNumber = class _MaskedNumber extends Masked {
  /** Single char */
  /** Single char */
...
function useIMask(opts, _temp) {
  ...
  const _onComplete = (0, import_react3.useCallback)(() => maskRef.current && (onComplete == null ? void 0 : onComplete(maskRef.current.value, maskRef.current)), [onComplete]);
