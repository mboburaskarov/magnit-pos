import {
  getUnit,
  toUnitless
} from "./chunk-BTX5LIJU.js";
import {
  Paper_default,
  getTransitionProps,
  reflow
} from "./chunk-RAIUXODW.js";
import {
  isMuiElement_default,
  useEnhancedEffect_default
} from "./chunk-GEKOJFBA.js";
import {
  ButtonBase_default,
  useEventCallback_default,
  useIsFocusVisible_default
} from "./chunk-CMPT6AQH.js";
import {
  Transition_default,
  useForkRef_default
} from "./chunk-2A3HXQ4K.js";
import {
  Typography_default
} from "./chunk-7B7EXASN.js";
import {
  useTheme
} from "./chunk-3Z45MZ4Q.js";
import {
  Popper,
  TextareaAutosize,
  appendOwnerState,
  ...
  useAutocomplete,
  useSlotProps
} from "./chunk-4DYTQX3H.js";
import {
  capitalize_default
} from "./chunk-66TXNA2N.js";
import {
...
var Collapse = React3.forwardRef(function Collapse2(inProps, ref) {
  ...
  return (0, import_jsx_runtime4.jsx)(TransitionComponent, _extends({
    ...
    children: (state, childProps) => (0, import_jsx_runtime4.jsx)(CollapseRoot, _extends({
      as: component,
      className: clsx_default(classes.root, className, {
      ...
      children: (0, import_jsx_runtime4.jsx)(CollapseWrapper, {
        ownerState: _extends({}, ownerState, {
          state
        }),
        className: classes.wrapper,
        ref: wrapperRef,
        children: (0, import_jsx_runtime4.jsx)(CollapseWrapperInner, {
          ownerState: _extends({}, ownerState, {
            state
          }),
...
var Alert = React10.forwardRef(function Alert2(inProps, ref) {
  ...
  return (0, import_jsx_runtime12.jsxs)(AlertRoot, _extends({
    ...
    children: [icon !== false ? (0, import_jsx_runtime11.jsx)(AlertIcon, {
      ...
      ownerState,
      className: classes.action,
      children: (0, import_jsx_runtime11.jsx)(AlertCloseButton, _extends({
        size: "small",
        ...
        children: (0, import_jsx_runtime11.jsx)(AlertCloseIcon, _extends({
          fontSize: "small"
        }, closeIconProps))
      }))
    }) : null]
...
true ? Alert.propTypes = {
   ...
   * @default 'success'
   */
  severity: import_prop_types4.default.oneOf(["error", "info", "success", "warning"]),
  /**
   * The extra props for the slot components.
   * You can override the existing props or add new ones.
   *
...
var Popper2 = React12.forwardRef(function Popper3(inProps, ref) {
  var _slots$root;
...
var Fab = React26.forwardRef(function Fab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime29.jsx)(FabRoot, _extends({
    className: clsx_default(classes.root, className),
    component,
    disabled,
    focusRipple: !disableFocusRipple,
...
true ? Fab.propTypes = {
   ...
   * @default 'default'
   */
  color: import_prop_types15.default.oneOfType([import_prop_types15.default.oneOf(["default", "error", "info", "inherit", "primary", "secondary", "success", "warning"]), import_prop_types15.default.string]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
...
var PaginationItem = React32.forwardRef(function PaginationItem2(inProps, ref) {
  ...
  return type === "start-ellipsis" || type === "end-ellipsis" ? (0, import_jsx_runtime35.jsx)(PaginationItemEllipsis, {
    ...
    className: clsx_default(classes.root, className),
    children: "…"
  }) : (0, import_jsx_runtime36.jsxs)(PaginationItemPage, _extends({
    ref,
    ownerState,
    component,
    disabled,
    ...
    children: [type === "page" && page, Icon ? (0, import_jsx_runtime35.jsx)(PaginationItemPageIcon, {
      as: Icon,
      ownerState,
      className: classes.icon
    }) : null]
...
true ? PaginationItem.propTypes = {
  ...
  components: import_prop_types17.default.shape({
    first: import_prop_types17.default.elementType,
    last: import_prop_types17.default.elementType,
    next: import_prop_types17.default.elementType,
    previous: import_prop_types17.default.elementType
  }),
  /**
   * If `true`, the component is disabled.
   * @default false
   ...
   */
  page: import_prop_types17.default.node,
  /**
   ...
   * @default 'page'
   */
  type: import_prop_types17.default.oneOf(["end-ellipsis", "first", "last", "next", "page", "previous", "start-ellipsis"]),
  /**
   * The variant to use.
   * @default 'text'
   */
...
var Pagination = React33.forwardRef(function Pagination2(inProps, ref) {
  ...
  const {
    ...
    hideNextButton = false,
    hidePrevButton = false,
    renderItem = (item) => (0, import_jsx_runtime37.jsx)(PaginationItem_default, _extends({}, item)),
    shape = "circular",
    showFirstButton = false,
    showLastButton = false,
    siblingCount = 1,
  ...
  return (0, import_jsx_runtime37.jsx)(PaginationRoot, _extends({
...
true ? Pagination.propTypes = {
   ...
   * @default 'standard'
   */
  color: import_prop_types18.default.oneOfType([import_prop_types18.default.oneOf(["primary", "secondary", "standard"]), import_prop_types18.default.string]),
  /**
   ...
   * @default false
   */
  hideNextButton: import_prop_types18.default.bool,
  /**
   * If `true`, hide the previous-page button.
   * @default false
   */
  hidePrevButton: import_prop_types18.default.bool,
  /**
   ...
   */
  renderItem: import_prop_types18.default.func,
  /**
   * The shape of the pagination items.
   * @default 'circular'
   */
  shape: import_prop_types18.default.oneOf(["circular", "rounded"]),
  /**
   ...
   * @default 'text'
   */
  variant: import_prop_types18.default.oneOfType([import_prop_types18.default.oneOf(["outlined", "text"]), import_prop_types18.default.string])
} : void 0;
...
var Star_default = createSvgIcon((0, import_jsx_runtime38.jsx)("path", {
...
var StarBorder_default = createSvgIcon((0, import_jsx_runtime39.jsx)("path", {
...
function IconContainer(props) {
  ...
  return (0, import_jsx_runtime40.jsx)("span", _extends({}, other));
}
...
function RatingItem(props) {
  ...
  const container = (0, import_jsx_runtime40.jsx)(RatingIcon, {
  ...
  if (readOnly) {
    return (0, import_jsx_runtime40.jsx)("span", _extends({}, labelProps, {
      children: container
    }));
  }
  return (0, import_jsx_runtime41.jsxs)(React36.Fragment, {
    children: [(0, import_jsx_runtime41.jsxs)(RatingLabel, _extends({
      ownerState: _extends({}, ownerState, {
        emptyValueFocused: void 0
      }),
      htmlFor: id
    }, labelProps, {
      children: [container, (0, import_jsx_runtime40.jsx)("span", {
        className: classes.visuallyHidden,
        children: getLabelText(itemValue)
      })]
    })), (0, import_jsx_runtime40.jsx)("input", {
      className: classes.visuallyHidden,
      onFocus,
      onBlur,
      onChange,
...
true ? RatingItem.propTypes = {
  ...
  disabled: import_prop_types19.default.bool.isRequired,
  emptyIcon: import_prop_types19.default.node,
  focus: import_prop_types19.default.number.isRequired,
  getLabelText: import_prop_types19.default.func.isRequired,
  highlightSelectedOnly: import_prop_types19.default.bool.isRequired,
  hover: import_prop_types19.default.number.isRequired,
  icon: import_prop_types19.default.node,
  IconContainerComponent: import_prop_types19.default.elementType.isRequired,
  isActive: import_prop_types19.default.bool.isRequired,
  itemValue: import_prop_types19.default.number.isRequired,
  labelProps: import_prop_types19.default.object,
  name: import_prop_types19.default.string,
  onBlur: import_prop_types19.default.func.isRequired,
  onChange: import_prop_types19.default.func.isRequired,
  onClick: import_prop_types19.default.func.isRequired,
  onFocus: import_prop_types19.default.func.isRequired,
  ownerState: import_prop_types19.default.object.isRequired,
  ratingValue: import_prop_types19.default.number,
  ratingValueRounded: import_prop_types19.default.number,
  readOnly: import_prop_types19.default.bool.isRequired
} : void 0;
var defaultIcon = (0, import_jsx_runtime40.jsx)(Star_default, {
  fontSize: "inherit"
});
var defaultEmptyIcon = (0, import_jsx_runtime40.jsx)(StarBorder_default, {
  fontSize: "inherit"
});
...
var Rating = React36.forwardRef(function Rating2(inProps, ref) {
  ...
  return (0, import_jsx_runtime41.jsxs)(RatingRoot, _extends({
    ref: handleRef,
    ...
    children: [Array.from(new Array(max)).map((_3, index) => {
      ...
      if (precision < 1) {
        ...
        return (0, import_jsx_runtime40.jsx)(RatingDecimal, {
          className: clsx_default(classes.decimal, isActive && classes.iconActive),
          ownerState,
          iconActive: isActive,
          children: items.map(($, indexDecimal) => {
            const itemDecimalValue = roundValueToPrecision(itemValue - 1 + (indexDecimal + 1) * precision, precision);
            return (0, import_jsx_runtime40.jsx)(RatingItem, _extends({}, ratingItemProps, {
      ...
      ownerState,
      children: [(0, import_jsx_runtime40.jsx)("input", {
        className: classes.visuallyHidden,
        value: "",
        id: `${name}-empty`,
        type: "radio",
...
true ? Rating.propTypes = {
   ...
   * @default 'Empty'
   */
  emptyLabelText: import_prop_types19.default.node,
  /**
   ...
   * }
   */
  getLabelText: import_prop_types19.default.func,
  /**
   * If `true`, only the selected icon will be highlighted.
   * @default false
   */
  highlightSelectedOnly: import_prop_types19.default.bool,
  /**
   * The icon to display.
   ...
   * }
   */
  IconContainerComponent: import_prop_types19.default.elementType,
  /**
   * Maximum rating.
   * @default 5
   */
   ...
   */
  onChangeActive: import_prop_types19.default.func,
  /**
   * @ignore
   */
   ...
   * @ignore
   */
  onMouseMove: import_prop_types19.default.func,
  /**
   * The minimum increment value change allowed.
   * @default 1
   */
  precision: chainPropTypes(import_prop_types19.default.number, (props) => {
...
var Skeleton = React37.forwardRef(function Skeleton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime42.jsx)(SkeletonRoot, _extends({
    as: component,
    ref,
    className: clsx_default(classes.root, className),
    ownerState
...
var SpeedDial = React39.forwardRef(function SpeedDial2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiSpeedDial"
  });
  ...
  const eventTimer = React39.useRef();
  React39.useEffect(() => {
    return () => {
      clearTimeout(eventTimer.current);
    };
  }, []);
  const focusedAction = React39.useRef(0);
  const nextItemArrowKey = React39.useRef();
  const actions = React39.useRef([]);
  actions.current = [actions.current[0]];
  const handleOwnFabRef = React39.useCallback((fabFef) => {
  ...
  const allItems = React39.Children.toArray(childrenProp).filter((child) => {
    if (true) {
  ...
  return (0, import_jsx_runtime45.jsxs)(SpeedDialRoot, _extends({
    className: clsx_default(classes.root, className),
    ref,
    role: "presentation",
    onKeyDown: handleKeyDown,
    ...
    children: [(0, import_jsx_runtime44.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime44.jsx)(SpeedDialFab, _extends({
        color: "primary",
        ...
        ref: handleFabRef,
        ownerState,
        children: React39.isValidElement(icon) && isMuiElement_default(icon, ["SpeedDialIcon"]) ? React39.cloneElement(icon, {
          open
        }) : icon
      }))
...
var _excluded26 = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
...
var Tooltip = React40.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React40.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime46.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  const isRtl = theme.direction === "rtl";
  const [childNode, setChildNode] = React40.useState();
  const [arrowRef, setArrowRef] = React40.useState(null);
  const ignoreNonTouchEvents = React40.useRef(false);
  const disableInteractive = disableInteractiveProp || followCursor;
  const closeTimer = React40.useRef();
  const enterTimer = React40.useRef();
  const leaveTimer = React40.useRef();
  const touchTimer = React40.useRef();
  ...
  if (true) {
    const {
      current: isControlled
    } = React40.useRef(openProp !== void 0);
    React40.useEffect(() => {
  ...
  const prevUserSelect = React40.useRef();
  const stopTouchInteraction = React40.useCallback(() => {
  ...
  const [, setChildIsFocusVisible] = React40.useState(false);
  const handleBlur = (event) => {
    handleBlurVisible(event);
    if (isFocusVisibleRef.current === false) {
  ...
  const popperRef = React40.useRef();
  const handleMouseMove = (event) => {
    const childrenProps2 = children.props;
  ...
  const popperOptions = React40.useMemo(() => {
  ...
  return (0, import_jsx_runtime47.jsxs)(React40.Fragment, {
    children: [React40.cloneElement(children, childrenProps), (0, import_jsx_runtime46.jsx)(PopperComponent, _extends({
...
var _excluded27 = ["className", "delay", "FabProps", "icon", "id", "open", "TooltipClasses", "tooltipOpen", "tooltipPlacement", "tooltipTitle"];
...
var SpeedDialAction = React41.forwardRef(function SpeedDialAction2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiSpeedDialAction"
  });
  ...
  const [tooltipOpen, setTooltipOpen] = React41.useState(tooltipOpenProp);
...
true ? SpeedDialAction.propTypes = {
   ...
   * @default 0
   */
  delay: import_prop_types24.default.number,
  /**
   * Props applied to the [`Fab`](/material-ui/api/fab/) component.
   * @default {}
   */
  FabProps: import_prop_types24.default.object,
  /**
   ...
   */
  TooltipClasses: import_prop_types24.default.object,
  /**
   * Make the tooltip always visible when the SpeedDial is open.
   * @default false
   */
  tooltipOpen: import_prop_types24.default.bool,
  /**
   * Placement of the tooltip.
   * @default 'left'
   */
  tooltipPlacement: import_prop_types24.default.oneOf(["bottom-end", "bottom-start", "bottom", "left-end", "left-start", "left", "right-end", "right-start", "right", "top-end", "top-start", "top"]),
  /**
   * Label to display in the tooltip.
   */
  tooltipTitle: import_prop_types24.default.node
} : void 0;
...
var _excluded28 = ["className", "icon", "open", "openIcon"];
...
var SpeedDialIcon = React43.forwardRef(function SpeedDialIcon2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiSpeedDialIcon"
  });
  ...
  function formatIcon(icon, newClassName) {
    if (React43.isValidElement(icon)) {
      return React43.cloneElement(icon, {
...
true ? SpeedDialIcon.propTypes = {
   ...
   */
  openIcon: import_prop_types25.default.node,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var TabScrollButton = React46.forwardRef(function TabScrollButton2(inProps, ref) {
...
true ? TabScrollButton.propTypes = {
   ...
   */
  direction: import_prop_types26.default.oneOf(["left", "right"]).isRequired,
  /**
   * If `true`, the component is disabled.
   * @default false
   */
   ...
   */
  orientation: import_prop_types26.default.oneOf(["horizontal", "vertical"]).isRequired,
  /**
   * The extra props for the slot components.
   * You can override the existing props or add new ones.
   * @default {}
...
var _excluded31 = ["aria-label", "aria-labelledby", "action", "centered", "children", "className", "component", "allowScrollButtonsMobile", "indicatorColor", "onChange", "orientation", "ScrollButtonComponent", "scrollButtons", "selectionFollowsFocus", "slots", "slotProps", "TabIndicatorProps", "TabScrollButtonProps", "textColor", "value", "variant", "visibleScrollbar"];
...
var Tabs = React48.forwardRef(function Tabs2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTabs"
  });
  ...
  const [displayStartScroll, setDisplayStartScroll] = React48.useState(false);
  const [displayEndScroll, setDisplayEndScroll] = React48.useState(false);
  const [updateScrollObserver, setUpdateScrollObserver] = React48.useState(false);
...
var _excluded33 = ["children", "className", "color", "disabled", "disableFocusRipple", "fullWidth", "onChange", "onClick", "selected", "size", "value"];
...
var ToggleButton = React49.forwardRef(function ToggleButton2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiToggleButton"
  });
...
true ? ToggleButton.propTypes = {
   ...
   * @default 'standard'
   */
  color: import_prop_types29.default.oneOfType([import_prop_types29.default.oneOf(["standard", "primary", "secondary", "error", "info", "success", "warning"]), import_prop_types29.default.string]),
  /**
   * If `true`, the component is disabled.
   * @default false
   */
...
var _excluded34 = ["children", "className", "color", "disabled", "exclusive", "fullWidth", "onChange", "orientation", "size", "value"];
...
var ToggleButtonGroup = React50.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiToggleButtonGroup"
  });
...
true ? ToggleButtonGroup.propTypes = {
   ...
   * @default false
   */
  exclusive: import_prop_types30.default.bool,
  /**
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-XWLDMJHQ.js.map
