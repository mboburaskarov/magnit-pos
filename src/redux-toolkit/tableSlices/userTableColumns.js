...
const usersTableColumns = createSlice({
  name: 'usersTableColumns',
  initialState: {
    columns,
    loading: false,
  },
...
export const { resetTableHeader, updateTableHeader, removeCustomColumn, setTableColumns, resetColumnsWidth, changeColumnSequence } = usersTableColumns.actions
export const usersTableColumnsSlice = usersTableColumns.reducer
