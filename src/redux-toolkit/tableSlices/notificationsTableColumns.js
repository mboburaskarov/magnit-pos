...
const notificationsTableColumns = createSlice({
  name: 'notificationsTableColumns',
  initialState: {
    columns,
    loading: false,
  },
...
export const { resetTableHeader, updateTableHeader, removeCustomColumn, setTableColumns, resetColumnsWidth, changeColumnSequence } =
  notificationsTableColumns.actions
export const notificationsTableColumnsSlice = notificationsTableColumns.reducer
