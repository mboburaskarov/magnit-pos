...
export default function tableHeaderSelector({ bonusColumns, t, setOrderStoring, orderStoring, setOpenSellerBonusHistoryDrawer }) {
  const columns = bonusColumns?.map((el) => {
