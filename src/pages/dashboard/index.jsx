...
export default function DashboarPage() {
  ...
  const { data: topStores, isLoading: isTopStoreLoading } = useQuery(
    ['TopStores', dashboard_filter], 
    () => requests.dashboradTopStores(dashboard_filter),
    { enabled: shouldLoadTopsData }
  )
  const { data: payments, isLoading: isPaymentsLoading } = useQuery(
    ['payments', dashboard_filter], 
    () => requests.dashboradPayments(dashboard_filter),
    { enabled: shouldLoadTopsData }
  )
  ...
  const { data: topSellers, isLoading: isTopSellerLoading } = useQuery(
    ['TopSellers', dashboard_filter], 
    () => requests.dashboradTopSellers(dashboard_filter),
    { enabled: shouldLoadTopsData }
  )
  
  const isTopsDataLoading = isTopStoreLoading || isPaymentsLoading || isTransactionLoading || 
                           isTopProductsLoading || isTopBonusProductLoading || isTopSellerLoading
