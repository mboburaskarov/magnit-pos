...
function ChangePriceDashboard({ data }) {
  return (
    ...
    >
      {[
        { title: 'Количество', value: 'count', endText: 'ед.' },
        { title: 'Общая старая цена', value: 'total_old_retail_price', endText: 'сум' },
        { title: 'Общая новая цена', value: 'total_new_retail_price', endText: 'сум' },
      ].map((stat) => (
...
export default ChangePriceDashboard
