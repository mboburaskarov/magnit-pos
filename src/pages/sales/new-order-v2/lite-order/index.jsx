// LiteOrder.jsx - Refactored version
...
// Import custom hooks
import { usePaymentOperations } from '@hooks/sale/usePaymentOperations'
import { useSaleOperations } from '@hooks/sale/useSaleOperations'
import { usePaymentShortcuts } from '@hooks/sale/useKeyboardShortcuts'
...
function LiteOrder({
  ...
  const { setValue, getValues, errors, control, watch } = useFormContext()
