  ...
  return (
    <Box
      ...
      sx={(theme) => ({
        padding: '8px 16px',
        borderRadius: 3.5,
        backgroundColor: selected ? theme.palette.grey[countOnTop ? 200 : 100] : countOnTop ? theme.palette.grey[100] : 'transparent',
        color: selected ? theme.palette.grey[600] : theme.palette.grey[400],
        fontWeight: 600,
        fontSize: 16,
        lineHeight: '19px',
        border: 0,
        ...
        '&:hover': {
          backgroundColor: theme.palette.grey[countOnTop ? 200 : 100],
          color: selected ? theme.palette.grey[600] : theme.palette.grey[400],
          '#countTop': { backgroundColor: theme.palette.grey[countOnTop ? 200 : 100] },
        },
      })}
    >
      {icon || ''} {name}
