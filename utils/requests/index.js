...
export const requests = {
  ...
  getProductsExcelByImportReport: (filter) => requestEXCEL.get(`v1/product/export-products-by-import${qs.stringify(filter, { addQueryPrefix: true })}`),
  ...
  saveMarkingToCartItem: ({ id, data }) => request.put(`v1/cart_item/${id}/markings`, data),
